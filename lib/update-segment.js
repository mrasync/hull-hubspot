...
exports.default = function (_ref, _ref2, _ref3) {
  ...
  var hubspot = new _hubspot2.default({ clientID: clientID, clientSecret: clientSecret, token: token, refresh_token: refresh_token, portal_id: portal_id, traits: traits });
  return true;
};
